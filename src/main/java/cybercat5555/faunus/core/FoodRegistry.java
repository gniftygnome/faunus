...
public final class FoodRegistry {
    ...
    public static final FoodComponent IGUANA_RAW_TAIL = new FoodComponent.Builder().hunger(1).saturationModifier(0.1f).build();
    public static final FoodComponent IGUANA_COOKED_TAIL = new FoodComponent.Builder().hunger(3).saturationModifier(0.3f).build();
    public static final FoodComponent IGUANA_RAW_MEAT = new FoodComponent.Builder().hunger(2).saturationModifier(0.2f).build();
    public static final FoodComponent IGUANA_COOKED_MEAT = new FoodComponent.Builder().hunger(6).saturationModifier(0.6f).build();
}